...
import type {
  PendleMarket,
  PendleMarketInterface,
} from "../../../../protocols/pendle/core/PendleMarket";
...
export class PendleMarket__factory {
  ...
  static createInterface(): PendleMarketInterface {
    return new Interface(_abi) as PendleMarketInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PendleMarket {
    return new Contract(address, _abi, runner) as unknown as PendleMarket;
  }
}
