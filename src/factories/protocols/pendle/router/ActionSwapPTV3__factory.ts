...
import type {
  ActionSwapPTV3,
  ActionSwapPTV3Interface,
} from "../../../../protocols/pendle/router/ActionSwapPTV3";
...
export class ActionSwapPTV3__factory {
  static readonly abi = _abi;
  static createInterface(): ActionSwapPTV3Interface {
    return new Interface(_abi) as ActionSwapPTV3Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ActionSwapPTV3 {
    return new Contract(address, _abi, runner) as unknown as ActionSwapPTV3;
  }
}
