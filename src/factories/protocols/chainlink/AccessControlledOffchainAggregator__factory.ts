...
} from "../../../protocols/chainlink/AccessControlledOffchainAggregator";
...
export class AccessControlledOffchainAggregator__factory {
  ...
  static createInterface(): AccessControlledOffchainAggregatorInterface {
    return new Interface(_abi) as AccessControlledOffchainAggregatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AccessControlledOffchainAggregator;
  }
}
