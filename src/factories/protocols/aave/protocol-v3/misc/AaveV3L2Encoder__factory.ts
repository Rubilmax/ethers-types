...
import type {
  AaveV3L2Encoder,
  AaveV3L2EncoderInterface,
} from "../../../../../protocols/aave/protocol-v3/misc/AaveV3L2Encoder";
...
export class AaveV3L2Encoder__factory {
  static readonly abi = _abi;
  static createInterface(): AaveV3L2EncoderInterface {
    return new Interface(_abi) as AaveV3L2EncoderInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AaveV3L2Encoder {
    return new Contract(address, _abi, runner) as unknown as AaveV3L2Encoder;
  }
}
