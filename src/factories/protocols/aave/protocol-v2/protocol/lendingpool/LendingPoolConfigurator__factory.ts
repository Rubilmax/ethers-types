...
} from "../../../../../../protocols/aave/protocol-v2/protocol/lendingpool/LendingPoolConfigurator";
...
export class LendingPoolConfigurator__factory {
  ...
  static createInterface(): LendingPoolConfiguratorInterface {
    return new Interface(_abi) as LendingPoolConfiguratorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LendingPoolConfigurator;
  }
}
