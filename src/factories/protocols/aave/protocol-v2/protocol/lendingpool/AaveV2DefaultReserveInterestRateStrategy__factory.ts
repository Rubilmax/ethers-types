...
} from "../../../../../../protocols/aave/protocol-v2/protocol/lendingpool/AaveV2DefaultReserveInterestRateStrategy";
...
export class AaveV2DefaultReserveInterestRateStrategy__factory {
  ...
  static connect(
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AaveV2DefaultReserveInterestRateStrategy;
  }
}
