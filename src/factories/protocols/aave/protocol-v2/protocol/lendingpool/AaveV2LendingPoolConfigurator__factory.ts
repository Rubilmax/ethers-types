...
import type {
  ...
  AaveV2LendingPoolConfiguratorInterface,
} from "../../../../../../protocols/aave/protocol-v2/protocol/lendingpool/AaveV2LendingPoolConfigurator";
...
export class AaveV2LendingPoolConfigurator__factory {
  static readonly abi = _abi;
  static createInterface(): AaveV2LendingPoolConfiguratorInterface {
    return new Interface(_abi) as AaveV2LendingPoolConfiguratorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AaveV2LendingPoolConfigurator;
  }
}
