...
} from "../../../../protocols/compound/v3-comet/Configurator";
...
export class Configurator__factory {
  static readonly abi = _abi;
  static createInterface(): ConfiguratorInterface {
    return new Interface(_abi) as ConfiguratorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): Configurator {
    return new Contract(address, _abi, runner) as unknown as Configurator;
  }
}
