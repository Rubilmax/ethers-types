...
import type {
  MainnetBulker,
  MainnetBulkerInterface,
} from "../../../../../protocols/compound/v3-comet/bulkers/MainnetBulker";
...
export class MainnetBulker__factory {
  static readonly abi = _abi;
  static createInterface(): MainnetBulkerInterface {
    return new Interface(_abi) as MainnetBulkerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MainnetBulker {
    return new Contract(address, _abi, runner) as unknown as MainnetBulker;
  }
}
