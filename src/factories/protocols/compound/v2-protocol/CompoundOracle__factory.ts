...
import type {
  ...
  UniswapConfig,
} from "../../../../protocols/compound/v2-protocol/CompoundOracle";
...
export class CompoundOracle__factory {
  ...
  static createInterface(): CompoundOracleInterface {
    return new Interface(_abi) as CompoundOracleInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CompoundOracle {
    return new Contract(address, _abi, runner) as unknown as CompoundOracle;
  }
}
