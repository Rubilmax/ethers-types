...
export interface ComptrollerG7Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_become"
...
export namespace CompSpeedUpdatedEvent {
...
export interface ComptrollerG7 extends BaseContract {
  connect(runner?: ContractRunner | null): ComptrollerG7;
  ...
  _setCompSpeed: TypedContractMethod<
    [cToken: AddressLike, compSpeed: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getEvent(
    key: "CompSpeedUpdated"
  ): TypedContractEvent<
    CompSpeedUpdatedEvent.InputTuple,
    CompSpeedUpdatedEvent.OutputTuple,
    CompSpeedUpdatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "CompSpeedUpdated(address,uint256)": TypedContractEvent<
      CompSpeedUpdatedEvent.InputTuple,
      CompSpeedUpdatedEvent.OutputTuple,
      CompSpeedUpdatedEvent.OutputObject
    >;
    CompSpeedUpdated: TypedContractEvent<
      CompSpeedUpdatedEvent.InputTuple,
      CompSpeedUpdatedEvent.OutputTuple,
      CompSpeedUpdatedEvent.OutputObject
    >;
