...
export interface BlueIrmInterface extends Interface {
  getFunction(
...
export interface BlueIrm extends BaseContract {
  connect(runner?: ContractRunner | null): BlueIrm;
  waitForDeployment(): Promise<this>;

  interface: BlueIrmInterface;
