...
export interface MorphoCompoundSupplyVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export namespace AccruedEvent {
  ...
  export type OutputTuple = [user: string, index: bigint, unclaimed: bigint];
...
export namespace ClaimedEvent {
  export type InputTuple = [user: AddressLike, claimed: BigNumberish];
  export type OutputTuple = [user: string, claimed: bigint];
  export interface OutputObject {
    user: string;
    claimed: bigint;
  }
...
export interface MorphoCompoundSupplyVault extends BaseContract {
  connect(runner?: ContractRunner | null): MorphoCompoundSupplyVault;
  ...
  userRewards: TypedContractMethod<
    [arg0: AddressLike],
    [[bigint, bigint] & { index: bigint; unclaimed: bigint }],
    "view"
  >;
  ...
  filters: {
    "Accrued(address,uint256,uint256)": TypedContractEvent<
      AccruedEvent.InputTuple,
      AccruedEvent.OutputTuple,
      AccruedEvent.OutputObject
    >;
