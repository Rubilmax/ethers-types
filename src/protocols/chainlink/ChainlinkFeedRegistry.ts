...
export interface ChainlinkFeedRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "confirmFeed"
...
export interface ChainlinkFeedRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ChainlinkFeedRegistry;
  waitForDeployment(): Promise<this>;

  interface: ChainlinkFeedRegistryInterface;
