...
export interface ATokenV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATOKEN_REVISION"
      | "DOMAIN_SEPARATOR"
...
export interface ATokenV3 extends BaseContract {
  connect(runner?: ContractRunner | null): ATokenV3;
  waitForDeployment(): Promise<this>;

  interface: ATokenV3Interface;
