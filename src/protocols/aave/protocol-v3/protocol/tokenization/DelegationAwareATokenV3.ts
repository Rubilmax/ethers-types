...
export interface DelegationAwareATokenV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATOKEN_REVISION"
      | "DOMAIN_SEPARATOR"
...
export namespace DelegateUnderlyingToEvent {
  export type InputTuple = [delegatee: AddressLike];
  export type OutputTuple = [delegatee: string];
  export interface OutputObject {
    delegatee: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface DelegationAwareATokenV3 extends BaseContract {
  connect(runner?: ContractRunner | null): DelegationAwareATokenV3;
  waitForDeployment(): Promise<this>;

  interface: DelegationAwareATokenV3Interface;
  ...
  delegateUnderlyingTo: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "delegateUnderlyingTo"
  ...
  >;
  getEvent(
    key: "DelegateUnderlyingTo"
  ): TypedContractEvent<
    DelegateUnderlyingToEvent.InputTuple,
    DelegateUnderlyingToEvent.OutputTuple,
    DelegateUnderlyingToEvent.OutputObject
  >;
  getEvent(
    key: "Initialized"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "DelegateUnderlyingTo(address)": TypedContractEvent<
      DelegateUnderlyingToEvent.InputTuple,
      DelegateUnderlyingToEvent.OutputTuple,
      DelegateUnderlyingToEvent.OutputObject
    >;
    DelegateUnderlyingTo: TypedContractEvent<
      DelegateUnderlyingToEvent.InputTuple,
      DelegateUnderlyingToEvent.OutputTuple,
      DelegateUnderlyingToEvent.OutputObject
    >;
