...
export interface AaveV3PoolConfiguratorInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AaveV3PoolConfigurator extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV3PoolConfigurator;
  waitForDeployment(): Promise<this>;

  interface: AaveV3PoolConfiguratorInterface;
