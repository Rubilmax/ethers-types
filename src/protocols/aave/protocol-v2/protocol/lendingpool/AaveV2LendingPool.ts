...
export interface AaveV2LendingPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AaveV2LendingPool extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV2LendingPool;
  waitForDeployment(): Promise<this>;

  interface: AaveV2LendingPoolInterface;
  ...
  LENDINGPOOL_REVISION: TypedContractMethod<[], [bigint], "view">;
  ...
  setConfiguration: TypedContractMethod<
    [asset: AddressLike, configuration: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "LENDINGPOOL_REVISION"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
