...
export interface DelegationAwareATokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATOKEN_REVISION"
      | "DOMAIN_SEPARATOR"
...
export interface DelegationAwareATokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): DelegationAwareATokenV2;
  waitForDeployment(): Promise<this>;

  interface: DelegationAwareATokenV2Interface;
