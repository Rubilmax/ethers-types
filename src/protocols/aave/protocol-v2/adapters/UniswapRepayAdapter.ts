...
export interface UniswapRepayAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESSES_PROVIDER"
...
export interface UniswapRepayAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapRepayAdapter;
  ...
  swapAndRepay: TypedContractMethod<
    [
