...
export interface AaveV2ProtocolDataProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESSES_PROVIDER"
      | "getAllATokens"
...
export interface AaveV2ProtocolDataProvider extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV2ProtocolDataProvider;
  waitForDeployment(): Promise<this>;

  interface: AaveV2ProtocolDataProviderInterface;
