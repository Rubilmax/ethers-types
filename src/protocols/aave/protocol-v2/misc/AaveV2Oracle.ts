...
export interface AaveV2OracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_CURRENCY"
      | "BASE_CURRENCY_UNIT"
...
export interface AaveV2Oracle extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV2Oracle;
  waitForDeployment(): Promise<this>;

  interface: AaveV2OracleInterface;
