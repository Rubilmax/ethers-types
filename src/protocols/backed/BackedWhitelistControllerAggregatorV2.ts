...
export interface BackedWhitelistControllerAggregatorV2Interface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
...
export interface BackedWhitelistControllerAggregatorV2 extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): BackedWhitelistControllerAggregatorV2;
  waitForDeployment(): Promise<this>;

  interface: BackedWhitelistControllerAggregatorV2Interface;
