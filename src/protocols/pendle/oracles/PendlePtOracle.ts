...
export interface PendlePtOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PendlePtOracle extends BaseContract {
  connect(runner?: ContractRunner | null): PendlePtOracle;
  waitForDeployment(): Promise<this>;

  interface: PendlePtOracleInterface;
