...
export interface PendleERC4626SYInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "accruedRewards"
...
export interface PendleERC4626SY extends BaseContract {
  connect(runner?: ContractRunner | null): PendleERC4626SY;
  waitForDeployment(): Promise<this>;

  interface: PendleERC4626SYInterface;
