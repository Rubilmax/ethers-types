...
export interface PendleYTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PT"
...
export interface PendleYT extends BaseContract {
  connect(runner?: ContractRunner | null): PendleYT;
  waitForDeployment(): Promise<this>;

  interface: PendleYTInterface;
